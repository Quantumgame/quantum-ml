...
sys.path.append('/home/ssk4/sandbox/ml_project/quantum-ml/nanowire_model')
...
def calculate_2d_map(ind):
    ...
    d1 = [200e-3,get_random(-0.15),get_random(0.05),1]
    b2 = [get_random(-250e-3,sigma_mean=0.02),get_random(0.0),get_random(0.05),1]
    d2 = [200e-3,get_random(0.15),get_random(0.05),1]
    ...
    physics_model['K_onsite'] = np.random.uniform(25e-3,50e-3)
